...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		OBJECT(MODEL_BLACK_BOBOMB, 21, -84, -2657, 0, -180, 0, 0x00000000, bhvBobombBuddy),
		OBJECT(MODEL_BOBOMB_BUDDY, -511, 916, -3962, 0, -135, 0, 0x00000000, bhvBobombBuddy),
		OBJECT(MODEL_BLACK_BOBOMB, -1438, -84, -2665, 0, -135, 0, 0x00000000, bhvBobombBuddy),
