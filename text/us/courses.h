COURSE_ACTS(COURSE_BOB, _(" 1 PEA PARK"),
       _("CONSTRUCTION CLIMBING")     , _("PEAMAN SECRET") , _("RUNNING FOR RED COINS"),
       _("THE PEANGUINS")          , _("PEAGGLER PAINS")        , _("-CAPS- VANISHING METALLICALLY"))

COURSE_ACTS(COURSE_WF, _(" 2 MT. MACABRE & MT. MISERY"),
       _("CLIMBING MT. MISERY")        , _("FUNNY FLOWERS")    , _("SECRETS OF THE BLOOD LAKE"),
       _("CRIMSON COINS"), _("MEATMAN OF THE MOUNTAIN")    , _("-CAPS- SECRET OF THE MISERY LAKE"))

COURSE_ACTS(COURSE_JRB, _(" 3 DESPONDENT DUNES"),
       _("REDS OF THE SANDY RUINS")    , _("HINT ART 1") , _("HINT ART 2"),
       _("SIMPLE SLIDING")  , _("-CAPS- METALLIC SECRET")     , _("-CAPS- VANISHING ONTO THE SHIP"))

SECRET_STAR(COURSE_CCM, _(" 4 GARLIC GOLFING"))

COURSE_ACTS(COURSE_BBH, _(" 5 BIG BOO'S HAUNT"),
       _("COIN COLLECTING")            , _("ONLY 1 STAR") , _("I MEAN IT"),
       _("GO AWAY")          , _("IT'S A SINGLE STAR STAGE")             , _("FUCK OFF"))
...
SECRET_STAR(COURSE_PSS, _("   SHITSHINE ISLES"))
